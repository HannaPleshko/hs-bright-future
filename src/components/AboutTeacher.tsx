          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  Еще будучи студенткой БГУИР, я поняла, что программирование преподается слишком сжато и теоретично. 
                ...
                <p>
                  ...
                  Оказалось, со слов моих студентов, у меня есть талант объяснять сложные вещи простыми словами и разбивать сложные темы на понятные части.
                </p>
                <p>
