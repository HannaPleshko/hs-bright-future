...
const FAQ = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Рекомендуем дополнительно 2-4 часа в день для выполнения домашних заданий и практики. Это поможет закрепить материал и быстрее прогрессировать."
    },
    {
    ...
    },
    {
      ...
      answer: "Мы предоставляем все необходимые инструменты для трудоустройства: портфолио, подготовку к собеседованиям, год бесплатного сопровождения. Большинство наших выпускников находят работу в IT."
    },
    {
    ...
    {
      question: "Сколько длится весь курс?",
      answer: "Примерно 9 месяцев, но все зависит от группы и ее успеваемости. Мы адаптируем темп обучения под возможности студентов."
    },
    {
      question: "Чем ваш курс отличается от других?",
      answer: "Мини-группы до 7 человек, индвидуальные занятия по запросу, год бесплатной поддержки после окончания, высокий процент трудоустройства и персональный подход к каждому студенту."
    },
  ];
